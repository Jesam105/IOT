...
<head>
  ...
  <title>Blood Pressure - BioMedical Wearable Device</title>
    ...
    <div class="mt-3">
      ...
      <div class="flex flex-1 flex-col items-center lg:items-start">
        <div class="btn btn-white flex flex-col items-center gap-6">
          ...
          <input type="number" id="blood" name="rate" placeholder="Blood Pressure" class="btn btn-white" />
          <input type="submit" name="submit" value="Check Blood Pressure"
